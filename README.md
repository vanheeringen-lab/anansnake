...
```bash
https://github.com/vanheeringen-lab/anansnake.git
```

Create a conda environment
```bash
mamba env create -n anansnake -f anansnake/requirements.yaml
```
...
ANANSE can take tonnes of memory. If your machine freezes, reduce the number of threads and/or mem_mb.
